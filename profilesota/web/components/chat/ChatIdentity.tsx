...
/**
 * Pure presentation component for rendering user identity in chat messages.
 * Does NOT fetch data — receives resolved profile fields as props.
 */
