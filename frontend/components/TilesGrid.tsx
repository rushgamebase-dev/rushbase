...
export const CLOSED_TILE_IDS = new Set<number>([
  ...
  59,
  // 1 foreclosed on 2026-04-16 for unpaid Harberger tax
  38,
  // 1 foreclosed on 2026-04-18 for unpaid Harberger tax
  10,
]);

/**
 * Tiles reserved — sale not authorized via UI.
 * V1 officially dead 2026-05-06 — no UI gates, holders free to exit.
 */
